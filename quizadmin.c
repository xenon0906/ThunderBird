...
strcpy(quiz[19].answerB, "Sonai Gandhi");
...
quiz[19].correct_answer = 'A';
  ...
  for (int i = 0; i < TOTAL_QUESTIONS; i++)
  {
    ...
    printf("%s", quiz[i].question);
    resetConsoleColor();
    printf("\n");

    printf("A) ");
    setConsoleColor(RED_COLOR);
    printf("%s", quiz[i].answerA);
    resetConsoleColor();
    printf("\n");

    printf("B) ");
    setConsoleColor(RED_COLOR);
    printf("%s", quiz[i].answerB);
    resetConsoleColor();
    printf("\n");

    printf("C) ");
    setConsoleColor(RED_COLOR);
    printf("%s", quiz[i].answerC);
    resetConsoleColor();
    printf("\n");

    printf("D) ");
    setConsoleColor(RED_COLOR);
    printf("%s", quiz[i].answerD);
    resetConsoleColor();
    printf("\n");
